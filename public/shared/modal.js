/* modal.js: simple info modal that occupies the center of the screen. Can be dismissible
 * by user (via click/tap) or permanent. Only one modal can be displayed at a time.
 */
