define(["exports", "mithril", "css", "models", "bootstrap", "typeahead"], function(exports, m, css, models) {
        ...
        m(".user-listing",
          ctrl.userList.map(function(user) {
            return m("div", {
              ...
              user.name.length === 0 ? user.email : user.name + " <" + user.email + ">", " ",
                ...
                m("button.btn.btn-sm.btn-default", {
                  ...
                  onclick: function(e) {
                    ...
                    if (indexOfExistingUser >= 0) {
                      ...
                      $("#cannot-add-user-modal").modal("show");
  ...
  var CannotAddUserModal = {
    view: function() {
      return m(".modal.fade#cannot-add-user-modal",
        m(".modal-content.col-xs-offset-3.col-sm-offset-3.col-md-offset-3.col-xs-6.col-sm-6.col-md-6",
          ...
          m(".modal-body", "There is no user in the system with that email address."),
          m(".modal-footer",
            m("button", {
                onclick: function(e) {
                  $("#cannot-add-user-modal").modal("hide");
                  e.preventDefault();
                  return false;
                }
              }, "Dismiss"
