/*
 * server/synchronizedState/storeUncompressed.js: Datastore and logger for 
 *      the server's synchronized state system.
 */
        ...
        tmpWriteStream._write = (function(_doNotApply) {
            return (function(chunk, encoding, done) {
                ...
                lines.forEach((function(line) {
                    ...
                    if(_doNotApply) {
                        // If preparing a session for playback, rather than 
                        // immediately applying all updates, we keep them in one
                        // big array so we can apply them during playback.
