/*
 * createDB.js: creates a fresh database for use by CCAF
 */
...
exports.mkdb = function(dbPath) {
    ...
    // During development in 2017, we found ourselves discarding and rebuilding
    // the database frequently and needed an easy way to add a lot of users. If
    // accounts.csv is present, we use it to populate the users table.
